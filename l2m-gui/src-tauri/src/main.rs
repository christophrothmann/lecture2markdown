...
#[tauri::command]
async fn transcribe_slides_native(
...
#[tauri::command]
fn open_file_in_app_native(file_path: String) -> Result<(), String> {
    open_path_with_default_app(&file_path)
}

#[tauri::command]
fn open_anki_import_native(deck_name: String, tsv_content: String) -> Result<String, String> {
...
#[tauri::command]
async fn export_anki_apkg_native(
    deck_name: String,
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            save_file_native,
            open_file_in_app_native,
            open_anki_import_native,
            export_anki_apkg_native,
